...
export const BRAZIL_OFFLINE_GEO_DB: GeocodedLocation[] = [
  ...
  {
    id: 'rj-caxias-santa-cruz-da-serra',
    name: 'Casa da Minha Mãe (Santa Cruz da Serra)',
    display_name: 'Rua Camille Claudel, Lote 9, Quadra C 4 - Santa Cruz da Serra, Duque de Caxias - RJ',
    category: 'poi',
    lat: -22.6958,
    lng: -43.2785,
    keywords: [
  ...
  {
    id: 'rj-rio-cachambi-garcia-redondo',
    name: 'Casa da Minha Sogra (Cachambi)',
    display_name: 'Rua Garcia Redondo, 100 - Cachambi, Rio de Janeiro - RJ',
    category: 'poi',
    lat: -22.8885,
    lng: -43.2750,
    keywords: [
  ...
  {
    id: 'rj-marica-jacaroa-rua-n',
    name: 'Minha Casa (Jacaroá)',
    display_name: 'Rua N, 33 - Jacaroá, Maricá - RJ',
    category: 'poi',
    lat: -22.9265,
    lng: -42.8025,
    keywords: [
  ...
  {
    id: 'rj-caxias-escola-cordelia-paiva',
    name: 'Escola Cordélia Paiva (Parque Fluminense)',
    display_name: 'Escola Municipal Cordélia Paiva - Parque Fluminense, Duque de Caxias - RJ',
    category: 'poi',
    lat: -22.7520,
    lng: -43.3280,
    keywords: [
      'cordelia paiva',
      'escola cordelia',
      'escola cordélia paiva',
      'parque fluminense',
      'cordelia',
      'escola parque fluminense',
    ],
  },
  {
    id: 'rj-caxias-ciep-369',
    name: 'CIEP 369 (Jardim Primavera)',
    display_name: 'CIEP 369 Jornalista Claudir de Oliveira Gomes - Jardim Primavera, Duque de Caxias - RJ',
    category: 'poi',
    lat: -22.7230,
    lng: -43.2980,
    keywords: [
      'ciep 369',
      'ciep jardim primavera',
      'jardim primavera caxias',
      'claudir de oliveira',
      'escola jardim primavera',
    ],
  },
  {
    id: 'rj-caxias-ciep-476',
    name: 'CIEP 476 (Nova Campina)',
    display_name: 'CIEP 476 - Nova Campina, Duque de Caxias - RJ',
    category: 'poi',
    lat: -22.6580,
    lng: -43.2620,
    keywords: [
  ...
  {
    id: 'rj-caxias-ciep-229',
    name: 'CIEP 229 (Saracuruna)',
    display_name: 'CIEP 229 Cândido Portinari - Saracuruna, Duque de Caxias - RJ',
    category: 'poi',
    lat: -22.6880,
    lng: -43.2530,
    keywords: [
